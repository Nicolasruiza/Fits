(()=>{
  ...
  const requiresLookImage=page!=='wardrobe'&&page!=='unlock';
  const keep=l=>l&&!blocked.has(l.id)&&!l.inspiration&&!String(l.image||'').includes('inspiration-')&&(!requiresLookImage||!!String(l.image||'').trim());
