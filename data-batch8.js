...
addLook({id:'look-40',family:'family-navy-polo-cream',name:'Navy polo + cream chinos + brown loafers',image:'',formal:3,badges:['Office','Dinner','Weekend'],pieces:['navy-polo','cream-chinos','brown-loafers','brown-belt']});
})();
